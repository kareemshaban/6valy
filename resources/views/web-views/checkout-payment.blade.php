                ...
                <!-- Payment methods accordion-->
                    ...
                    <div class="row g-3">
                        ...
                        @endif
                            ...
                            <div class="col-sm-6">
                                <div class="card cursor-pointer">
                                    <div class="card-body __h-100px" id="tap-payment-button" >
                                        <a class="btn btn-block click-if-alone" >
                                            <img class="__inline-55 mt-0" src="{{asset('public/assets/front-end/img/visa-mastercard.png')}}"/>
                                        </a>
                                    </div>
                                </div>
                            </div>
...
@push('script')
  ...
  <script>
      $(document).ready(function (){
         $('#tap-payment-button').click(function (){
             ...
             $.ajax({
                 ...
                 success: function(result) {
                     $('#tabPaymentModal').modal("show");
                     $(".modal-body #name").val( "" );
                     $(".modal-body #number").val( "" );
                     $(".modal-body #exp_month").val("");
                     $(".modal-body #exp_year").val( "" );
                     $(".modal-body #cvc").val( "" );

                      $(".modal-body #reset").click(function (){
                          $('#tabPaymentModal').modal("show");
                          $(".modal-body #name").val( "" );
                          $(".modal-body #number").val( "" );
                          $(".modal-body #exp_month").val("");
