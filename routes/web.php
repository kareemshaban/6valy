...
Route::post('card_token', [App\Http\Controllers\TabPaymentController::class, 'card_token'])->name('card_token');
Route::get('create_charge', [App\Http\Controllers\TabPaymentController::class, 'create_charge'])->name('create_charge');
Route::any('tapPay_callback', [App\Http\Controllers\TabPaymentController::class, 'callback'])->name('tapPay_callback');
